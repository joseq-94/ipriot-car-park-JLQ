...
| ---------- |----------------------------|-----------------------------------|
| `CarPark`    | Location<br/>capacity      | Add_vehicle<br/>Remove_vehicule   |
| `Sensor`     | Sensor_Id<br/>Detect_plate | Detect_vehicule<br/>get_plate     |
| `Display`    | Message<br/>Temperature    | Show_message<br/>Show_temperature |
